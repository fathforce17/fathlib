...
<html>
  ...
  <body>
    <span class="preheader">{{config('config.general.app_name')}}</span>
          ...
          <div class="content">
            ...
            <table role="presentation" border="0" cellpadding="0" cellspacing="0">
              <tr>
                  <td class="content-block">
                    <img style="max-height: 60px;" src="{{url(config('config.assets.icon'))}}">
                  </td>
                  <td class="content-block">
                    <div class="header">
                        <h1 class="align-right">{{config('config.general.app_name')}}</h1>
                    </div>
                  </td>
              </tr>
            </table>
            ...
            <div class="footer">
              <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                ...
                <tr>
                  <td class="content-block">
                    <span class="apple-link"><a style="color: inherit;" href="mailto:{{config('config.general.app_email')}}">{{config('config.general.app_email')}}</a> | <a style="color: inherit;" href="{{config('config.general.app_website')}}">{{config('config.general.app_website')}}</a> | {{config('config.general.app_phone')}}</span>
                  </td>
                </tr>
                <tr>
                  <td class="content-block powered-by">
                    &copy; <a href="{{url('/')}}">{{config('config.general.app_name')}}</a>
                  </td>
                </tr>
              </table>
            </div>
